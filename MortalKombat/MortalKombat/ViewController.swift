...
class ViewController: UIViewController {
    ...
    func setupFighter() {
        ...
        fight1.imageScreenTwo = "Scorpion2"
        ...
        fight2.imageScreenTwo = "SubZero2"
        ...
        fight4.imageScreenTwo = "LiuKang2"
        ...
        fight5.imageCharacter = "Johnny"
        fight5.imageScreenTwo = "Johnny2"
        ...
        fight6.imageScreenTwo = "KungLao2"
...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "CellXIB", for: indexPath) as? MyTableViewCellXIB {
            cell.setupMyCustomCell(fight: arrayFighter[indexPath.row])
            return cell
        }
